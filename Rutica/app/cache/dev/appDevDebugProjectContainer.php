...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '163.178.107.130', 'port' => NULL, 'dbname' => 'rutica', 'user' => 'adm', 'password' => 'saucr.092', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Rutica\\DataBaseBundle\\Entity'))), 'Rutica\\DataBaseBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DataBaseBundle' => 'Rutica\\DataBaseBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_57b6be67467bc3886a6422f49784433c88e8bcf9a1a42c19814bf4df0c201a4b');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('jorgesax14@gmail.com');
        $a->setPassword('Gamma26PUTA');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Rutica\\AdministradorBundle/Resources/views'), 'Administrador');
        $instance->addPath(($this->targetDirs[3].'\\src\\Rutica\\DataBaseBundle/Resources/views'), 'DataBase');
        $instance->addPath(($this->targetDirs[3].'\\src\\Rutica\\RutasBundle/Resources/views'), 'Rutas');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdministradorBundle' => 'Rutica\\AdministradorBundle\\AdministradorBundle',
                'DataBaseBundle' => 'Rutica\\DataBaseBundle\\DataBaseBundle',
                'RutasBundle' => 'Rutica\\RutasBundle\\RutasBundle',
            ...
            'database_host' => '163.178.107.130',
            'database_port' => NULL,
            'database_name' => 'rutica',
            'database_user' => 'adm',
            'database_password' => 'saucr.092',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'jorgesax14@gmail.com',
            'mailer_password' => 'Gamma26PUTA',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'jorgesax14@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Gamma26PUTA',

 ...
 */
class Actividad extends \Rutica\DataBaseBundle\Entity\Actividad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Rutica\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'id', '' . "\0" . 'Rutica\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'nombre');
        }
